    ...
    <>
      ...
      >
        ...
        >
          ...
          <Link
            href="/"
            title="בית"
            style={{ display: "flex", alignItems: "center", color: "#374151", textDecoration: "none" }}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#374151">
      ...
      >
        ...
        <nav style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          {/* 1. חנות */}
          <Link href="/" onClick={close} style={linkStyle}>
            חנות
          </Link>
          ...
          {role === "ADMIN" && (
            <div>
              ...
              >
                <span>אדמין</span>
                <span style={{ fontSize: 11, color: "#9ca3af" }}>{adminOpen ? "▲" : "▼"}</span>
              </button>
