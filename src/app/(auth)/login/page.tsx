  ...
  return (
    <div className="w-full max-w-sm space-y-2">
      <div className="text-center">
        <h1 className="text-3xl font-bold mb-1 text-gray-900 dark:text-white">ברוכים הבאים</h1>
        ...
        <p className="mt-2 text-base text-gray-600 dark:text-gray-400">התחבר כדי להמשיך</p>
      </div>
