  ...
  return (
    <div className="w-full max-w-sm space-y-8">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-black dark:text-white">איפוס סיסמא</h1>
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">פנה למנהל לאיפוס הסיסמא שלך</p>
      </div>
